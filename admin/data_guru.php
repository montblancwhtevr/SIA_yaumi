                ...
                <div class="col-lg-12">
                    <div >
                        ...
                        <div class="panel-body">
                            ...
                            <table class='table table-striped table-bordered table-hover' id='dataTables-example'>
                               ...
                               <!--      <th>No</th> -->
                                ...
                                while($row=mysql_fetch_array($result)){?>
                                    ...
                                    <td align='center'>
                                    <a href="#" class='open_modal' id='<?php echo $row['id_guru']; ?>'><button type='button' class='btn btn-success btn-circle'><i class='fa fa-edit fa-fw'></i></button></a>
                                    <a href="#" onclick="confirm_modal('delete/guru.php?&id_guru=<?php echo $row['id_guru']; ?>');"><button type='button' class='btn btn-danger btn-circle'><i class='fa fa-trash-o'></i></button></a>
                                    </td>
                                    </tr>
                                    <?php }
                                ?>
                            ...
                            <a href="#" class="btn btn-success btn-sm" data-target="#ModalAdd" data-toggle="modal"><i class="fa fa-plus fa-fw"></i>Tambah Guru</button></a>
                            <a href="#" class="btn btn-success btn-sm" ><i class="fa fa-plus fa-fw"></i>Import Guru</button></a>
                            </div>
                        <!-- /.panel footer-->
                        </div>
                        <!-- /.panel-body -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
          <form action="proses/proses_save_guru.php" name="modal_popup" enctype="multipart/form-data" method="POST">
            
                <table>
                <div class="form-group" style="padding-bottom: 10px;">
                  <tr>  
                  <td><label for="NIS">NIP</label></td>
                  <td><input type="number" name="nip"  class="formcontrol" placeholder="Nomor Guru" required/></td>
                  </tr>
                </div>
                ...
                <div class="form-group" style="padding-bottom: 10px;">
                  ...
                  <td><input type="text" name="nama"  class="formcontrol" placeholder="Nama Guru" required/></td>
                  </tr>
                </div>
                ...
                <div class="form-group" style="padding-bottom: 10px;">
                  ...
                  <td><input type="date" name="lahir"  class="formcontrol" placeholder="Tanggal Lahir" required/></td>
                  </tr>
                </div>
                ...
                <div class="form-group" style="padding-bottom: 10px;">
                  ...
                  <td><input type="number" name="telepon"  class="formcontrol" placeholder="Nomor Telepon" required/></td>
                  </tr>
                </div>
                ...
                <div class="form-group" style="padding-bottom: 10px;">
                  ...
                  <td>
                    <select name="jabatan" class="formcontrol">
                        <option value="" selected disabled>--</option>

...
<body>
                    ...
                    <div class="panel panel-red">
                        ...
                        <div class="panel-body">
                            ...
                            <table class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <?php 
                                include "koneksi.php";
                                $sql="select nilai.id_nilai, siswa.id_siswa, nilai.id_siswa, siswa.nama_siswa, nilai.id_mapel, nilai.harian, mapel.mapel, nilai.absen, nilai.uts, nilai.uas, nilai.jumlah, nilai.rata  from nilai inner join siswa ON siswa.id_siswa = nilai.id_siswa inner join mapel ON nilai.id_mapel = mapel.id_mapel where id_kelas=4";
                                ...
                                while($row=mysql_fetch_array($result)){?>
                                    ...
                                    <a href="#" onclick="confirm_modal('proses_delete_nilai_kelas_empat.php?&id_nilai=<?php echo $row['id_nilai']; ?>');"><button type='button' class='btn btn-danger btn-circle'><i class='fa fa-trash-o'></i></button></a>
                                    </td>
                                    </tr>
                                    <?php }
                                ?>
        ...
        <div class="modal-content">
          ...
          <div class="modal-header">
            ...
            <div class="modal-body">
              <form action="proses_save_input_kelas_empat.php" name="modal_popup" enctype="multipart/form-data" method="POST">
                    ...
                    <div class="form-group" style="padding-bottom: 10px;">
                      ...
                      <td>
                        <select name="modal_nama" class="form-control">
                            ...
                            <?php  
                                $q = mysql_query("SELECT * FROM siswa where id_kelas=4");
    ...
    $(document).ready(function() {
        ...
        $(".open_modal").on('click',function(e) {
          var m = $(this).attr("id");
               $.ajax({
                       url: "modal_edit_nilai_kelas_empat.php",
                       type: "GET",
                       data : {id_nilai: m,},

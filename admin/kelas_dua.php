...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Data Kelas 2 </h3>
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 text-right">
                                    ...
                                    <?php
                                    include "koneksi.php";
                                    $result=mysql_query("SELECT * FROM siswa where id_kelas=2"); echo "".mysql_num_rows($result)
                                    ?>
                                    </div>
                                    <div>Lihat Nilai</div>
                                </div>
                        ...
                        <a href="lihat_nilai_kelas_dua.php">
                    ...
                    <div class="panel panel-green">
                        ...
                        <a href="input_nilai_kelas_dua.php">
                            <div class="panel-footer">
                                <span class="pull-left">View Details</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>

...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Data Nilai Kelas 1</h3>
                    ...
                    <div class="panel panel-red">
                        ...
                        <div class="panel-body">
                            ...
                            <table class='table table-striped table-bordered table-hover' id='dataTables-example'>
                                ...
                                <?php 
                                include "koneksi.php";
                                $sql="select siswa.id_siswa, nilai.id_siswa, siswa.nama_siswa, nilai.id_mapel,mapel.mapel, nilai.harian, nilai.absen, nilai.uts, nilai.uas, nilai.jumlah, nilai.rata  from siswa inner join nilai ON siswa.id_siswa = nilai.id_siswa inner join mapel on nilai.id_mapel = mapel.id_mapel where id_kelas=1";
                            ...
                            <a href="download/download_nilai_kelas_satu.php" class="btn btn-success btn-sm" ><i class="fa fa-plus fa-fw"></i>Print Nilai</button></a>    
                            </div>
                        <!-- /.panel footer-->
                        </div>
                        <!-- /.panel-body -->

...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header">Data Nilai Kelas 3</h3>
                ...
                <div class="row">
                    ...
                    <div class="panel panel-red">
                        ...
                        <div class="panel-body">
                            ...
                            <a href="download/download_nilai_kelas_tiga.php" class="btn btn-success btn-sm" ><i class="fa fa-plus fa-fw"></i>Print Nilai</button></a>    
                            </div>
                        <!-- /.panel footer-->
                        </div>
                        <!-- /.panel-body -->
